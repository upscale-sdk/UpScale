...
cflags += -mhypervisor -std=c99 -Wall -g3 -O -I${BUILD_DIR}  -Winit-self\
...
${K1_ERIKA_APP_NAME}-cflags += ${K1_CLUSTER_INCLUDE_DIRS_OPT}\
  -Wno-unused-function -save-temps=obj -DK1_ERIKA_PLATFORM_MOS\
  ${K1_LIBGOMP_DEFS}
...
${K1_IO_APP_NAME}-lflags += -L${K1_OUTPTDIR} -lpsocoffload\
  -lmppapower -lmppanoc -lmpparouting -lpcie_queue -lmppaipc\
...
${K1_OUTPTDIR}/build/libee.a ${K1_OUTPTDIR}/build/libgomp.a ${K1_OUTPTDIR}/build/libpsocoffload.a:
	make -C ${K1_ERIKA_FILES} -f ${K1_ERIKA_FILES}/p-socrates.mk\
  arch=${arch} K1_ERIKA_PLATFORM=mOS K1_ERIKA_SCHEDULER=${K1_ERIKA_SCHEDULER}
