...
#define EE_INLINE__ static
/* Used to declare an inline function before the actual definition */
#define EE_DECLARE_INLINE__ static
#else
#define EE_INLINE__ static inline
/* Used to declare an inline function before the actual definition */
#define EE_DECLARE_INLINE__ static inline
#endif /* __NO_INLINE_ || __STRICT_ANSI__ */

#define EE_ALWAYS_INLINE__ __attribute__((always_inline))
#define EE_NEVER_INLINE__ __attribute__((noinline))
