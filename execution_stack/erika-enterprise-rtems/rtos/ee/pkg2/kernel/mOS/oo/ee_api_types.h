...
/* OSEK Style typedefs */
typedef EE_app_mode_id    AppModeType;
...
#define DECLARE_TASK_FUNC(Task) extern void TASK_FUNC(Task) ( void )
...
/* Forward declaration for TDB_tag */
struct EE_SN_tag;
typedef struct EE_SN_tag EE_SN;
