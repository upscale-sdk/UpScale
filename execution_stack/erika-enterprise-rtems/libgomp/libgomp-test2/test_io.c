...
int main (int argc, char** argv)
{
  ...
  clock_gettime(CLOCK_MONOTONIC, &start);       /* mark start time: also CLOCK_REALTIME and CLOCK_PROCESS_CPUTIME_ID have been tested */
  ...
  double diff = (end.tv_sec - start.tv_sec) * 1000000.0 + (end.tv_nsec - start.tv_nsec)/1000.0;
  ...
  GOMP_target(1 /* device id */,
              ...
              (void *) 2 /* Function executed on cluster side */,
