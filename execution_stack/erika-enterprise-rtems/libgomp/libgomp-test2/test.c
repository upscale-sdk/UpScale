...
#define CLOCK_IRQ          _K1_RM_INT_LINE_TIMER0
#define CLOCK_FREQ         (_K1_CPU_FREQ/(_K1_DEFAULT_CLOCK_DIV + 1))
#define CLOCK_RELOAD_1_MS  EE_MILLI_TO_TICKS(1, CLOCK_FREQ)

static void configure_clock ( void ) {
#ifndef EE_TRACE_KERNEL
  __k1_timer_general_setup();
  __k1_timer_setup_num(0, CLOCK_RELOAD_1_MS, CLOCK_RELOAD_1_MS, EE_FALSE);
  __k1_timer_interrupt_enable_num(0);
...
int main(void)
{
  ...
  CreateTask( &task1_id, EE_TASK_TYPE_EXTENDED, TASK_FUNC(Task1), 1U, 1U, 1U, 1024 );
