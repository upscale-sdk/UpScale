...
class XMLTagDictionary:
	KwToolchain = "toolchain"
	KwOption = "option"	
	KwOptionRLocation = "RLocation"
	KwOptionPythonLocation = "PythonLocation"
	KwVariable = "variable"
	KwVarName = "name"
	KwVarType = "type"
	KwVarValue = "value"
	KwVarSelectedValue = "selected_value"
	KwVarColor = "color"
	KwVarDescription = "description"
	KwCommand = "command"
	KwCmdName = "name"
	KwCmdType = "type"
	KwCmdOperation = "operation"	
	KwCmdDescription = "description"
	KwCmdStopOnFailure = "stoponfailure"	
	KwAction = "action"
	KwAcName = "name"	
	KwAcColor = "color"
