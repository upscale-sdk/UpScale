...
namespace {
    ...
    NBase range_multiplication(const NBase& r1, const NBase& r2)
    {
        ...
        if ((r1_lb.is<Nodecl::Analysis::MinusInfinity>()
                && r1_ub.is<Nodecl::Analysis::PlusInfinity>())
            || (r2_lb.is<Nodecl::Analysis::MinusInfinity>()
                && r2_ub.is<Nodecl::Analysis::PlusInfinity>()))
        {   // If r1 or/and r2 are [-INF, +INF], then return this range
    ...
    NBase InfinityCalculator::visit(const Nodecl::Conversion& n)
    {
