...
namespace Analysis {
            ...
            bool call_graph)
    {
        ...
        else
        {
            ...
            // or the set of functions specified in parameter \functions
            ...
            else
            {
                ...
                if (!not_found_functions.empty())
                {
                    ...
                    {
                        WARNING_MESSAGE("Function '%s' specified in parameter 'functions' have not been found.\n"
...
//     }
            ...
            bool psocrates)
    {
        ...
        for (ObjectList<ExtensibleGraph*>::const_iterator it = pcfgs.begin(); it != pcfgs.end(); ++it)
        {
            ...
            TaskDependencyGraph* tdg = new TaskDependencyGraph(*it, (*it)->get_name(), taskparts_enabled, psocrates);
            tdgs.insert(tdg);
